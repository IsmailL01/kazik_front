...
const gameTypes: CategoryItem[] = [
  ...
  { id: 'exclusive', label: 'Exclusive', src: '/exclusive.svg', alt: 'exclusive' },
...
const popularGames: CategoryItem[] = [
  ...
  { id: 'pre-release', label: 'Pre-release', src: '/pre-release.svg', alt: 'pre' },
  { id: 'popular', label: 'Popular', src: '/popular.svg', alt: 'pop' },
  { id: 'month', label: 'Games of the month', src: '/month.svg', alt: 'month' },
  { id: 'jackpots-pop', label: 'Jackpots', src: '/jackpots.svg', alt: 'jackpots' },
  { id: 'bonus', label: 'Bonus wagering', src: '/bonus.svg', alt: 'bonus' },
  { id: 'providers', label: 'Top providers', src: '/providers.svg', alt: 'providers' },
