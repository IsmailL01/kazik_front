...
export default function AuthModal({ opened, onClose }: AuthModalProps) {
  ...
  return (
    ...
    >
      <div className={`${classes.container} ${!showDesktopSideImage ? classes.singleMode : ''}`}>
        ...
        <div className={classes.formSide}>
          ...
          {view === 'forgot_password' ? (
            <Box mb="md">
              <Title order={3} className={classes.title}>Password recovery</Title>
            ...
            <Stack gap="md">
              ...
              {view !== 'forgot_password' && (
                <>
                  ...
                  <Group justify="center" className={classes.socialGroup} gap="md">
                    ...
                    <>
                      <Stack gap="xs">
                        <Checkbox
                          ...
                          label={
                            <>
                              I am at least 18 years old and accept <a href="#">Privacy Policy</a>, <a href="#">T&C</a>.
                            </>
                          }
                        />
                        <Checkbox
